...
Make sure to install `librdkafka` or `librdkafka-dev`

[Cannot install confluent-kafka](https://issueexplorer.com/issue/confluentinc/confluent-kafka-python/1190)

To install `librdkafka` on Mac OS use following steps:
* Install librdkafka with homebrew
* pip3 install --global-option=build_ext --global-option="-I/opt/homebrew/Cellar/librdkafka/1.8.2/include" --global-option="-L/opt/homebrew/Cellar/librdkafka/1.8.2/lib" confluent-kafka
