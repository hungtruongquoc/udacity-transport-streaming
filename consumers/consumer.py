...
BROKER_LINK = "PLAINTEXT://localhost:9092"
...
class KafkaConsumer:
    ...
    def __init__(
        ...
        self.broker_properties = {
            "group.id": "org.htruong.public.transportation.consumer"
        }

        if is_avro is True:
            self.consumer = AvroConsumer({
                "bootstrap.servers": BROKER_LINK,
    ...
    def _consume(self):
        ...
        try:
            logger.debug(f"Checking message on topic: {self.topic_name_pattern}")
